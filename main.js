...
function startGame() {
  ...
  document.getElementById(
    "turn"
  ).innerHTML = `<h3>It's Player <img class="button-img" src="./1-16405_american-red-cross-computer-icons-christian-cross-symbol.png"> turn</h3>`;
...
function handler(event) {
  if (step % 2 !== 0) {
    document.getElementById(event.target.id).innerHTML =
      '<img class="cross" src="./1-16405_american-red-cross-computer-icons-christian-cross-symbol.png">';
    document.getElementById(
      "turn"
    ).innerHTML = `<h3>It's Player <img class="button-img"  src="./421-4211837_fond-colors-circle-poster-u37711-transparent-red-strikethrough.png"> turn</h3>`; //display which player turn it is.
    step++;
    pos[event.target.id] = "x";
    winner("cross");
  } else {
    document.getElementById(event.target.id).innerHTML =
      '<img class="nought" src="./421-4211837_fond-colors-circle-poster-u37711-transparent-red-strikethrough.png">';
    document.getElementById(
      "turn"
    ).innerHTML = `<h3>It's Player <img class="button-img" src="./1-16405_american-red-cross-computer-icons-christian-cross-symbol.png"> turn</h3>`; //display which player turn it is.
    step++;
  ...
  if (
    ...
    if (val === "cross") {
      ...
      document.getElementById("turn").innerHTML =
        '<h3>&nbsp&nbsp<img class="button-img" src="./1-16405_american-red-cross-computer-icons-christian-cross-symbol.png"> Wins! Play Again</h3>';
      X++;
      document.getElementById("scoreX").innerHTML = `<h4>${X}</h4>`;
    } else {
      //displays message on the button,player2 wins
      document.getElementById("turn").innerHTML =
        '<h3>&nbsp&nbsp<img class="button-img"  src="./421-4211837_fond-colors-circle-poster-u37711-transparent-red-strikethrough.png"> Wins! Play Again</h3>';
      O++;
